...
{$ENDIF}
  ...
  Datasnap.DBClient, cxButtonEdit, cxLabel, dxBar, cxBarEditItem, dxBarExtItems,
  cxClasses, System.ImageList, Vcl.ImgList, cxGraphics, Vcl.Menus, JvExControls,
  JvLED, JvExComCtrls, JvStatusBar, csDXFunctions;
...
type
  ...
  TFrmPrincipal = class(TForm)
    ...
    dxBarCadPessoas: TdxBarLargeButton;
    dxBarSair: TdxBarLargeButton;
  ...
  public
    ...
    // caso nao use desmarque
    DXFunc: TcsDXFunctions;
...
begin
  ...
  DXFunc := TcsDXFunctions.Create;
  DXFunc.Translate_PTBR;
  ...
  dxBarStatic1.Caption := 'Bem-vindo ao EMS Point - ConFlex';
end;
